...
export const LogoIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M6.25,3.5H17.75A2.75,2.75,0,0,1,20.5,6.25V17.75A2.75,2.75,0,0,1,17.75,20.5H6.25A2.75,2.75,0,0,1,3.5,17.75V6.25A2.75,2.75,0,0,1,6.25,3.5ZM12,17.25a.75.75,0,0,0,.75-.75V7.5a.75.75,0,0,0-1.5,0V16.5A.75.75,0,0,0,12,17.25Zm-4.25-2.5a.75.75,0,0,0,.75-.75V10.5a.75.75,0,0,0-1.5,0v3.5A.75.75,0,0,0,7.75,14.75Zm8.5,0a.75.75,0,0,0,.75-.75V10.5a.75.75,0,0,0-1.5,0v3.5A.75.75,0,0,0,16.25,14.75Z"/>
    </svg>
);
...
export const TableCellsIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125V5.625c0-.621.504-1.125 1.125-1.125h17.25c.621 0 1.125.504 1.125 1.125v12.75c0 .621-.504 1.125-1.125 1.125m-17.25 0h17.25m-7.5-11.25h7.5m-7.5 0V5.625m0 3.75v3.75m0 0v3.75m-4.125-7.5h4.125m-4.125 0V5.625m0 3.75v3.75m0 0v3.75" />
  </svg>
);
...
export const UserGroupIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5zM10.5 1.5a9 9 0 105.25 16.237m-5.25-16.237c-3.181 0-5.875 1.12-8.064 2.924a12.08 12.08 0 00-2.131 3.411 12.08 12.08 0 00-1.258 5.84C1.372 16.31 3.41 18 5.685 18H6.5a4.5 4.5 0 014.5-4.5m-3.75-2.25a.75.75 0 00-1.5 0v3a.75.75 0 001.5 0v-3z" />
    </svg>
);
